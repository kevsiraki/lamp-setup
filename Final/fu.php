...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	if(empty($email_err)) {
	            //sends email
            $link2 = "<a href='comp424.technologists.cloud/forgot-username.php?key=" . $_POST["email"] . "&token=" . $basics["email_verification_link"] . "'>Retrieve Username</a>";
...
<body>
    <div class="wrapper">
        ...
        <p>Retrieve Username Link will be sent to your email (if verified).</p>
		...
		<div class="form-group">
		  ...
		  <small id="emailHelp" class="form-text text-muted">Make sure you verified.</small>
        </div>
		<b> 
		<div class="form-group">
